        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              La plataforma que revoluciona el alquiler de habitaciones, 
              conectando inquilinos y propietarios de forma inteligente y segura.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#about" className="hover:text-white transition-colors">¿Qué es Roomit?</a></li>
              <li><a href="#benefits" className="hover:text-white transition-colors">Ventajas</a></li>
              <li><a href="#how-it-works" className="hover:text-white transition-colors">Cómo funciona</a></li>
              <li><a href="#waitlist" className="hover:text-white transition-colors">Lista de espera</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="mailto:hola@roomit.app" className="hover:text-white transition-colors">Contacto</a></li>
